            ...
            <div class="d-flex flex-column align-content-end">
                    ...
                    <div class="auth-form-container text-start">
                        <form class="auth-form login-form" method="POST">
                            ...
                            <div class="email mb-3">
                                ...
                                <input id="signin-email" type="text" class="form-control signin-email"
                ...
                <footer class="app-auth-footer">
                    <div class="container text-center py-3">
                        ...
                        <small class="copyright">Created with <span class="sr-only">love</span><i class="fas fa-heart"
                                style="color: #fb866a;"></i> by <a class="app-link"
                                href="http://themes.3rdwavemedia.com" target="_blank">AKTI</a> for
                            Intership</small>
