...
<body style="padding: 4%">
    ...
    <table style="border-collapse:collapse;margin-left:6.27398pt; width: 99%;" cellspacing="0">
        ...
        <tr style="height:20pt">
            <td style="width:63pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:dotted;border-right-width:1pt"
                rowspan="2">
                <p style="text-indent: 0pt;padding-top: 8pt; text-align: center;">{{$datang_terlambat}}</p>
            </td>
            ...
            <td
                ...
                <p style="text-indent: 0pt;text-align: left;"><br />{{$sakit_opname}}</p>
            </td>
            <td
            ...
            <td
                ...
                <p style="text-indent: 0pt;text-align: left;"><br />{{$pulang_cepat}}</p>
            </td>
            <td
            ...
            <td style="width:45pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:dotted;border-right-width:1pt"
                rowspan="2">
                <p style="text-indent: 0pt;text-align: left;"><br />{{$tidak_hadir}}</p>
            </td>
        ...
        <tr style="height:19pt">
            ...
            <td
                ...
                <p style="text-indent: 0pt;text-align: left;"><br />{{$sakit_cd}}</p>
            </td>
            <td
            ...
            <td
                ...
                <p style="text-indent: 0pt;text-align: left;"><br />{{$tanpa_izin}}</p>
            </td>
            <td
    ...
    <table style="border-collapse:collapse;margin-left:6.27398pt; width: 99%;" cellspacing="0">
        ...
        <tr style="height:23pt">
            ...
            <td
                ...
                <p style="text-indent: 0pt;text-align: center;">{{$data->actual_safety}}</p>
            </td>
            <td
                ...
                <p style="text-indent: 0pt;text-align: center;">{{$data->remarks_safety}}</p>
            </td>
        </tr>
        <tr style="height:30pt">
            ...
            <td
                style="width:57pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->actual_quality}}</p>
            </td>
            <td
                style="width:104pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->remarks_quality}}</p>
            </td>
        </tr>
        <tr style="height:31pt">
            ...
            <td
                style="width:57pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->actual_productivity}}</p>
            </td>
            <td
                style="width:104pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->remarks_productivity}}</p>
            </td>
        </tr>
        <tr style="height:23pt">
            <td
            ...
            <td
                style="width:57pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->actual_cost}}</p>
            </td>
            <td
                style="width:104pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->remarks_cost}}</p>
            </td>
        </tr>
        <tr style="height:31pt">
            <td
            ...
            <td
                style="width:57pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center; padding-top: 7pt">{{$data->actual_moral}}</p>
            </td>
            <td
                style="width:104pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center; padding-top: 7pt">{{$data->remarks_moral}}</p>
            </td>
        </tr>
        <tr style="height:23pt">
            <td
            ...
            <td
                style="width:57pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->actual_lima_r}}</p>
            </td>
            <td
                style="width:104pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->remarks_lima_r}}</p>
            </td>
        </tr>
        <tr style="height:23pt">
            <td
    ...
    <table style="border-collapse:collapse;margin-left:6.27398pt; width: 99%;" cellspacing="0">
        <tr style="height:29pt">
            ...
            <td
                ...
                @if ($data->range < 12)
                <p class="s3" style="text-indent: 0pt;text-align: center; color:red">D</p>
                <p class="s3" style="padding-top: 1pt;text-indent: 0pt;text-align: center; color:red">(Poor)</p>
                @else
            ...
            <td
                style="width:75pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                @if ($data->range > 12 && $data->range < 17)
                <p class="s3" style="text-indent: 0pt;text-align: center; color:red">C</p>
                <p class="s3" style="padding-top: 1pt;text-indent: 0pt;text-align: center; color:red">(Enough)</p>
                @else
            ...
            <td
                ...
                @if ($data->range > 18 && $data->range < 23)
                <p class="s3" style="text-indent: 0pt;text-align: center;color:red">B</p>
                <p class="s3" style="padding-top: 1pt;text-indent: 0pt;text-align: center;color:red">(Good)</p>
                @else
            ...
            <td
                style="width:75pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                @if ($data->range > 24)
                <p class="s3" style="text-indent: 0pt;text-align: center;color:red">A</p>
                <p class="s3" style="padding-top: 1pt;text-indent: 0pt;text-align: center;color:red">(Excellent)</p>
                @else
    ...
    <table style="border-collapse:collapse;margin-left:6.27398pt; width: 99%;" cellspacing="0">
        ...
        <tr style="height:87pt">
            <td
                style="width:113pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->strong}}</p>
            </td>
            <td
                style="width:112pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->weakness}}</p>
            </td>
            <td
                style="width:113pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->skill}}</p>
            </td>
            <td
                style="width:113pt;border-top-style:solid;border-top-width:1pt;border-left-style:solid;border-left-width:1pt;border-bottom-style:solid;border-bottom-width:1pt;border-right-style:solid;border-right-width:1pt">
                <p style="text-indent: 0pt;text-align: center;">{{$data->knowledge}}</p>
            </td>
        </tr>
    </table>
