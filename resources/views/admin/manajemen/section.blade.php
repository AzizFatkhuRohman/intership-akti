                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <div class="modal fade" id="example{{$item->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{url('admin/manajemen/section/'.$item->id)}}"
                                                    ...
                                                    <div class="row">
                                                        <div class="col-6">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{$item->user->nama}}" name="pengguna" readonly>
                                                        </div>
                                                        <div class="col-6">
                                                            <label for="exampleFormControlInput1"
                                                            ...
                                                            <input type="text" class="form-control"
                                                                ...
                                                                value="{{$item->nama_section}}" required>
                                                        </div>
                                                        {{-- <div class="">
                                                            <label for="exampleFormControlInput1"
                                ...
                                <form action="{{url('admin/manajemen/section/'.$item->id)}}" method="post" id="section">
                                    @csrf
                                    @method('delete')
                                    <button class="btn btn-danger" type="button" onclick="section()">
