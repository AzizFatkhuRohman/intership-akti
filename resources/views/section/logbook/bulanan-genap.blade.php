          ...
          <tr>
            ...
            <td>
              <div class="d-flex">
                    ...
                    <div class="modal-dialog modal-lg">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="{{url('section/logbook/bulanan-genap/'.$item->id)}}" method="post">
                            @csrf
                            @method('put') 
                              <div class="mb-3">
                ...
                @endif
                <a href="{{url('section/logbook/bulanan-genap/'.$item->id)}}" target="_blank" rel="noopener noreferrer" class="btn btn-info"><svg xmlns="http://www.w3.org/2000/svg" width="16"
