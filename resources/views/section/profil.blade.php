    ...
    <div class="row gy-4 mt-3">
        <div class="col-12 col-lg-6">
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                ...
                <!--//app-card-header-->
                <form action="{{url('section/profil/'.Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="app-card-body px-4 w-100">
                        ...
                        <div class="item border-bottom py-3">
                            <div>
                                ...
                                <input type="text" class="form-control" value=" {{$data->nama_section}}" name="nama_section"
                                    required>
                            </div>
                            <!--//row-->
                        </div>
                    ...
                    <div class="item border-bottom py-3">
                        <div class="row justify-content-between align-items-center">
                            <div class="col-auto">
                                ...
                                <div class="item-data">{{$data->departement->nama_section}}</div>
                            </div>
                            <!--//col-->
                        </div>
                        <!--//row-->
