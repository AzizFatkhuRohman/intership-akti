            ...
            <div class="modal-body">
              <form action="{{url('mentor/logbook/bulanan-ganjil')}}" method="post">
                ...
                <div class="row">
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label"> SAFETY (KY Ability) (Smt4)</label>
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label"> SAFETY (KY Ability) (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Mampu menduga bahaya iNVISIBLE (KY Level 1 New Commer)" name="safety_ky_2" required>
                  </div>
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    ...
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_safety_ky_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_safety_ky_2"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">SAFETY (Idea Hyari Hatto) (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Mampu membuat idea HH dan dapat diterapkan di pos nya" name="safety_idea_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">SAFETY (Idea Hyari Hatto) (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" value="Tidak membuat idea HH"
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_safety_idea_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_safety_idea_2"
                      required>
                  </div>
                  ...
                  <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Tidak terjadi defect yang sama selama pemagangan di Job exist" name="div_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">DIV. QUALITY HISTORY</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_div_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_div_2"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_div_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_div_2" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">CUSTOMER / NEXT PROSES</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Melaporkan ketika mengetahui defect orang lain & tidak terjadi outflow" name="customer_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">CUSTOMER / NEXT PROSES</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Tidak melaporkan ketika mengetahui defect orang lain & terjadi outflow" name="customer_2"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_customer_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_customer_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">ANALISA PROBLEM (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Mampu menganalisa defect - improvement & tidak terjadi lagi" name="analisa_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">ANALISA PROBLEM (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Mampu menganalisana defect dan membuat improvement sederhana" name="analisa_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">ANALISA PROBLEM (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Tidak melaporkan ketika mengetahui defect orang lain & terjadi outflow" name="analisa_3"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_analisa_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_analisa_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_analisa_3" required>
                  </div>
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_reporting_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_reporting_2"
                      required>
                  </div>
                  <h5 class="mt-2">D. PRODUCTIVITY (MK : Toyota Production System)</h5>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Menguasai lebih dari 4 Job</label>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Menguasai kurang dari 4 Job</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="job_3" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kemauan belajar dan berkembang</label>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kesesuaian motivasi & Inisiatif</label>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Sistematika kerja dan ketelitian</label>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kecepatan dan daya tahan kerja</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="kerja_7" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kurang dari segi kecepatan dan tahan
                      kerja</label>
                  ...
                  <div class="col-4">
                    ...
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Tidak terjadi keterlambatan produksi karena problem tools atau equipment" name="tpm_1"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">PERSIAPAN PRODUKSI (TPM)</label>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">PERSIAPAN PRODUKSI (TPM)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1" value="Tidak melakukan TPM"
                      name="tpm_3" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_tpm_1"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="2" name="range_tpm_2"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_tpm_3"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_tpm_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_tpm_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_tpm_3" required>
                  </div>
                  <div class="col-4">
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_line_1"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="2" name="range_line_2"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_line_3"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_line_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_line_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_line_3" required>
                  </div>
                  <div class="col-4">
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_repair_1"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="2" name="range_repair_2"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_repair_3"
                      required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_repair_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_repair_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_repair_3" required>
                  </div>
                  <h5 class="mt-2">E. COST (MK : Improvement)</h5>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">PEMAKAIAN MATERIAL (INDIRECT)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_indirect_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_indirect_2" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label"> STD PEMAKAIAN MATERIAL (DIRECT)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Mematuhi pemakaian material sesuai standard proses (Gentan-I)" name="direct_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label"> STD PEMAKAIAN MATERIAL (DIRECT)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_direct_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_direct_2"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_direct_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_direct_2" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">RULE ABNORMALITY MATERIAL (Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Memahami pemakaian Mat. yg abnormal, bisa kontrol stok awal akhir" name="abnormality_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">RULE ABNORMALITY MATERIAL (Smt4)</label>
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_abnormality_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_abnormality_2"
                      required>
                  </div>
                  ...
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Inteligensi & Daya Pikir responsif</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="mindset_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">kurang responsif</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="mindset_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Logika berfikir responsif</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="mindset_3" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">kurang responsif</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="mindset_4" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Komunikasi dengan atasan, rekan
                      kerja</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_1" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">kurang berkomunikasi dengan atasan dan
                      rekan kerja</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_2" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kerja sama antar team kerja</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_3" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kurang interaktif dan kerjasama dengan
                      Tlnya</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_4" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kontak sosial terhadap sesama</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_5" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Kurang kontak sosial terhadap
                      sesama</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_6" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">Beradaptasi dengan cepat di area
                      baru</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_7" required>
                  </div>
                  <div class="col-4">
                    <label for="exampleFormControlInput1" class="form-label">kurang bisa beradaptasi di area
                      baru</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_8" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Keinginan untuk orang lain</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_9" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">kurang memiliki keinginan untuk orang
                      lain.</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="etika_10" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Mematuhi aturan JKN, Ontime, selalu SENAM
                      (Awal-Break-Lunch-Break)</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="jkn_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Pernah terlambat tanpa info ke TL/GL
                      (Awal-Break-Lunch-Break)</label>
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_qcc_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_qcc_2"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_qcc_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_qcc_2" required>
                  </div>
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">IDEA / IMPROVEMENT (Bef-Atf Smt3)
                      IDEA / IMPROVEMENT (Berkonsep Smt4)</label>
                    <input type="text" class="form-control" id="exampleFormControlInput1"
                      value="Mampu membuat IDEA/IMPROVEMENT hanya 1 kali dalam 1 bulan" name="idea_2" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="4" name="range_idea_1"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Range Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" value="0" name="range_idea_2"
                      required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_idea_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Actual Point</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="act_idea_2" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Memahami step-step TJI , Pernah training
                      TJI</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="tji_1" required>
                  </div>
                  <div class="col-6">
                    <label for="exampleFormControlInput1" class="form-label">Belum memahami step-step TJI</label>
                    <input type="number" min="0" max="4" class="form-control" id="nilai" name="tji_2" required>
                  </div>
                </div>
            </div>
