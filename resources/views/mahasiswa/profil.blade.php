            ...
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-start">
                ...
                <div class="app-card-body px-4 w-100">
                    ...
                    <form action="{{url('mahasiswa/profil-add')}}" method="post" enctype="multipart/form-data">
                        @else
                        <form action="{{url('mahasiswa/profil/'.Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                            @endif
                            @csrf
                            @method('put')
                            ...
                            <div class="item border-bottom py-3">
                                <div class="">
                                    ...
                                    <select class="select" aria-label="Default select example" name="dosen_id">
                                        @if (optional($data)->dosen)
                                        <option value="{{ optional($data->dosen->user)->nama }}">{{
                                            optional($data->dosen->user)->nama }}</option>
