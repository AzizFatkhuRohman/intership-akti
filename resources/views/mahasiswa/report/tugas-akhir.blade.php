    ...
    <div class="card" style="height: 50rem">
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{url('mahasiswa/report/tugas-akhir/'.$data->id)}}" method="post"
        ...
        <div class="card-body">
            ...
            <div class="text-center">
                <span>Belum ada {{$title}} yang diunggah</span>
            </div>
            @else
            <iframe src="{{asset('tugas_akhir/'.$data->nama_file)}}" frameborder="0" width="100%" height="100%"></iframe>
            @endif
        </div>
    </div>
</div>
