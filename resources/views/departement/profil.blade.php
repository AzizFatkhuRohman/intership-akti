...
<div class="container-xl">
            <div class="app-card app-card-account shadow-sm d-flex flex-column align-items-center mt-2">
                ...
                <!--//app-card-header-->
                <form action="{{url('departement/profil/'.Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="app-card-body px-4 w-100">
                        ...
                        <div class="item border-bottom py-3">
                            <div>
                                ...
                                <input type="text" class="form-control" value=" {{$data->nama_departement}}" name="nama_departement"
                                    required>
                            </div>
                            <!--//row-->
                        </div>
